    ...
    <div className="p-4" style={{ borderTop: '1px solid var(--border)', backgroundColor: 'var(--bg-sidebar)' }}>
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 border rounded px-3 py-2 focus:outline-none text-sm md:text-base"
          style={{ 
      ...
      <div className="mt-2 text-xs hidden md:block" style={{ color: 'var(--text-secondary)' }}>
